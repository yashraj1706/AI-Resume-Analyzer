  ...
  projects: [
    {
      ...
      description:
        "A smart irrigation system that uses sensors to monitor soil moisture and automates watering.",
    },
    {
      id: 2,
      name: "Resume Analyzer",
      description:
        "A web application that analyzes resumes for ATS compatibility and provides feedback for improvements.",
    },
    {
      id: 3,
      name: "E-Commerce Platform",
      description:
        "An online marketplace for buying and selling products with a focus on seamless user experience.",
    },
  ]
};
