...
function AddResume() {
  ...
  return (  
    <div>
      <div className="p-14 py-24 border items-center flex justify-center rounded-lg h-[280px] hover:scale-105 transition-all hover:shadow-md cursor-pointer border-dashed " onClick={()=>{setOpenDialog(true)}}>
        <PlusSquare />
      </div>
